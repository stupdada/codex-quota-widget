...
- 同时展示 7 天窗口和 5 小时窗口的实际剩余额度、理想刻度和节奏差值。
...
- v0.2.1 起新增“加速蹬！”综合建议：当 7 天剩余额度明显高于理想进度、且 5 小时窗口不紧张时，提醒可以更积极使用。
- v0.2.1 起顶部细条和 HUD 使用同一个综合状态信号灯：`加速蹬！` 为白色常亮提示，`节奏正常` 为蓝色提示。
...
| 加速蹬！ | 7 天剩余额度显著高于动态理想门槛，且 5 小时窗口不是偏快或紧张 |
| 正常 | 当前消耗与时间进度基本一致 |
